...
#define MEMORY_BOOT_MEM_SIZE (0x10000)
                    
#define MEMORY_MAIN_SEC_START (16)
#define MEMORY_MAIN_SEC_END (18)
#define MEMORY_MAIN_MEM_START (FLASH_SECTOR_16)
#define MEMORY_MAIN_MEM_SIZE (0x10000)
                    
#define MEMORY_FPGA_SEC_START (18)
#define MEMORY_FPGA_END_START (18)
